...
namespace MathematicalFormula
{
    ...
    abstract class AbstractShapesFormula
    {
        public void Default()
        {
        ...
        public abstract void AbstractArea();

        public abstract void AbstractPerimeter();

    }

    class AbstractCircle : AbstractShapesFormula
    {
        public int radius;
        public override void AbstractArea()
        {
        ...
        public override void AbstractPerimeter()
        {
    ...
    class AbstractRectangle : AbstractShapesFormula
    {
        public int width;
        public int height;
        public override void AbstractArea()
    ...
    class AbstractTriangle : AbstractShapesFormula
    {
